...
`04_data_filled/` থেকে **সিমুলেটেড টেস্ট-ডাটা সরিয়ে** `04_data_filled/archive/`-এ আর্কাইভ করা হয়েছে। এখন সক্রিয় ফোল্ডারে শুধু সিন্থেটিক ডাটাসেটর জন্য খালি টেমপ্লেট আছে:
...
## এক নজরে আসল ফলাফল (চট্টগ্রাম, synthetic dataset — 2026-09-11)
...
- ভোক্তা-টাকায় **জেলের অংশ (producer's share) ৭২.৪%**; মোট বিপণন ব্যবধান ২৫৯.৪৫ টাকা/কেজি (২৭.৬%) — A+B+R = spread হুবহু [PASS]
- চেইন-মার্জিন (chain-complete mean): **আরাতদার ২৭.০ টাকা/কেজি (৩.২%)**, বেপারি/ফড়িয়া ১০৮.৩ (১১.৫%), **খুচরা ১২৪.২ (১২.৮%)** — সবচেয়ে বড় অংশ খুচরা বিক্রেতার।
