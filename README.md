...
├── analysis_outputs/
│   ├── tables/                     ১২টি বিশ্লেষণ টেবিল (CSV, Excel-বান্ধব utf-8-sig)
│   ├── charts/                     ৭টি প্রস্তুত ফিগার (PNG, 150 dpi)
│   └── Analysis_Summary.xlsx       সব টেবিল এক ওয়ার্কবুকে (Index শিটসহ)
└── docs/
...
- ভোক্তা-টাকায় **জেলের অংশ (producer's share) ৭৩.৯%** — চেইনের সবচেয়ে বড় মার্জিন খুচরা বিক্রেতার (গড় ১২২ টাকা/কেজি ≈ ১৬.৭%)।
- আড়তদারের নিলাম-মার্জিন মাত্র ~২৫ টাকা/কেজি (৩.৪%) — কমিশন-ভিত্তিক ব্যবসার সঙ্গে সামঞ্জস্যপূর্ণ।
- বেপারি ২০ জন, ফড়িয়া ১০ জন; ৮৩% বছরব্যাপী ব্যবসা করে।
- পেমেন্টে MFS (বিকাশ/নগদ)-এর অংশ চেইনে নিচের দিকে বাড়ে (আড়তদার ১৪% → খুচরা ২৯%)।
- শীর্ষ সমস্যা: সাপ্লাই সিন্ডিকেট (৩১%), অবিক্রীত মাছ নষ্ট (৩১%), ফ্রোজেন আমদানির প্রতিযোগিতা (২৯%)।
...
| `inspect_template.py` ইত্যাদি (৪টি) | টেমপ্লেটের কাঠামো/কোডবুক/ভ্যালিডেশন/ফরম্যাট দেখায় — ডাটা ঢোকানোর আগে-পরে বোঝার জন্য |
