...
> `04_data_filled/Marine_Fish_Marketing_Data_Entry_Chattogram_REAL_FILLED.xlsx` (seed 20260315, 491 PO rows, 120 respondents, 15 pairs) থেকে — **এটাই এখন সক্রিয় আসল ডাটা**। সিমুলেটেড v2 আর্কাইভে।
...
- যাচাই: verify_filled ২৪/২৪ PASS, review_audit ৬২ PASS / ৩ WARN / ০ FAIL, clean_data ১১ flags (১.৩%), R quality gates ৩x PASS, compare_r_py ২০/২১ PASS (১টি Fisher-exact p diff 0.6603 vs 0.6640 — both non-significant, implementation difference)

আগের সিমুলেটেড v2 ফলাফল (PS ৭০.৯%, spread ২৪৬.৩৯) এখন `04_data_filled/archive/`-এ রেফারেন্স হিসেবে আর্কাইভ।
