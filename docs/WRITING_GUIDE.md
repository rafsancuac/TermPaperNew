...
4. খুচরা বিক্রেতার নিজের **উদ্ধৃত (quote) দাম** (Retailer_sell, T3/T11) ভোক্তা-প্রদেয় দামের চেয়ে গড়ে ~২.৫% বেশি — এটা নিলাম/দর-কষাকষির ব্যবধান; "retailer margin" হিসেবে ভোক্তা-অ্যাংকরড সংখ্যাটাই ব্যবহার করুন, quote-ভিত্তিক মার্জিনকে robustness হিসেবে আলোচনা করা যাবে।
5. K/D ফ্ল্যাগযুক্ত দাম গড়ের ভেতরে নেই (n কমে যায়) — মেথড অংশে উল্লেখ করুন।
6. পরিসংখ্যানে Methodology §3.8-এর নিয়ম মানুন: প্রতি প্রজাতির KW-তে n≥৫-সেল (বর্তমান ডাটায় পৌঁছায় না বলে exploratory n≥৩ টিয়ার ফ্ল্যাগ করা আছে), কোনো অবস্থায় প্রজাতি জুড়ে পুল করবেন না, এবং ৫%-এ দ্বি-পার্শ্বিক পরীক্ষা।
